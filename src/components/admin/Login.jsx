...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center h-screen'>
        <div className='w-full max-sm p-6 max-md:m-6 border border-primary/30
            ...
            <div className='flex flex-col items-center justify center'>
                ...
                text-gray-600'>
                    <div className='flex flex-col'>
                        ...
                        className='border-b-2 border-gray-300 p-2 outline-none mb-6'></input>
                    <div className='flex flex-col'>
                    ...
                    text-white rounded cursor-pointer hover:bg-primary/90 tansition-all'> Login</button>
