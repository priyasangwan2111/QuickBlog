  ...
  return  data?(
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        border-primary/35 bg-primary/5 font-medium text-primary'>michael</p>
      </div>
          ...
          <div className='flex flex-col gap-4'>
            {comments.map((item,index)=>(
              ...
              border-primary/5 max-w-xl p-4 rounded text-gray-600'>
                ...
                gap-2 text-xs'>{Moment(item.createdAt).fromNow()}
                </div>
              </div>
            ))}
          </div>
      ...
      <div className='max-w-3xl mx-auto'>
        ...
        max-w-lg'>
          ...
          px-8 hoover:scale-102 transition-all cursor-pointer' >Submit</button>
        </form>
